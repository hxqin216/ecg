...
def insertToMongoDB(set1):
    with open('Y_SU_ECG_cleaned_2.csv', 'r', encoding='utf-8') as csvfile:
    ...
    with open('X_SU_ECG_cleaned_2.csv', 'r', encoding='utf-8') as csvfile:
        reader = csv.DictReader(csvfile)
        counts = 0
        for signal in reader:
            ...
            data = {
                'fs': 250,
                'from': 'sudden-cardiac-death-holter-database-1.0.0',
                'lead': 'ECG',
                'p_signal': array_x,
